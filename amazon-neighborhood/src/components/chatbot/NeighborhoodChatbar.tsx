...
const DEMO: Record<string, { sentence: string; filters: ChatFilters }> = {
  ...
  'electronics':      { sentence: 'Here are electronics in your Neighborhood',   filters: { category: 'electronics', max_price: null, keywords: [],                listing_type_preference: 'any'      } },
  ...
  'donate':           { sentence: 'These items are free in your Neighborhood',    filters: { category: '',            max_price: null, keywords: [],                listing_type_preference: 'donate'   } },
